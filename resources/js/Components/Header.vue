    ...
    <section class="flex justify-between items-center w-[1480px] h-32">
        ...
        <div class="flex">
            <div class="flex flex-col">
                ...
                <span class="text-xs text-white pt-0.5 h-1 text-error"></span>
            </div>
    ...
    <section class="relative flex justify-center items-center bg-black w-full h-10 border-y-2 border-white text-white">
        <div class="w-[1480px] flex items-center justify-center">
            <div v-if="scrollPosition > 120" class="flex items-center justify-between pr-7 pl-7 w-full">
                <Link href="#" class="uppercase block font-semibold cursor-pointer text-white">Laravel optic shop</Link>
                <div class="flex">
            ...
            <nav class="absolute flex items-center h-9">
                <Link href="#" class="flex items-center h-full px-5 hover:bg-primary">Télescopes</Link>
                <Link href="#" class="flex items-center h-full px-5 hover:bg-primary">Occulaires</Link>
                <Link href="#" class="flex items-center h-full px-5 hover:bg-primary">Montures</Link>
                <Link href="#" class="flex items-center h-full px-5 hover:bg-primary">Promotions</Link>
            </nav>
        </div>
    </section>
</template>
